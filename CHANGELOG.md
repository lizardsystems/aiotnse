...
- Wrap `aiohttp.ClientResponseError` into `TNSEApiError`/`TNSEAuthError` in all request methods — HTTP errors (403, 500, etc.) are no longer leaked as raw aiohttp exceptions
